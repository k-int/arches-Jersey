...
class Command(BaseCommand):
    ...
    def handle(self, *arg, **options):
        ...
        def scan_and_add(value_to_change):
            if len(value_to_change) != 7: # this will get in all < but also those with decimals and >

                if re.match("^[0-9\.]*$", value_to_change): # check HER number is actually a number and no letters in
   ...
   #                    }
        ...
        ngroup_dict = {'574b58a3-e747-11e6-84a6-026d961c88e6' : '818ec4ae-2e44-11ea-8326-0275d4869ef4', # Heritage Asset
