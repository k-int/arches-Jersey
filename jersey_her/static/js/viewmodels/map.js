	...
	mapLayers = mapLayers.sort((a, b) => parseInt(a.layersortorder) - parseInt(b.layersortorder))
        ...
        var updateOpacity = function(layer, val) {
            ...
            _.each([
                ...
                //console.log(opacityType, "Type");
                console.log(opacityVal, "OpacityVal");
                //console.log(layer.type, "What is the layer type", startVal, opacityVal);
               // if (opacityType == "raster") {
                //    console.log(startVal, "StartVal");
                 //   console.log(opacityVal, "OpacityVal");
                 //   console.log(opacityType, "Type");
               // }
                ...
                if (parseFloat(startVal)) {
                    layer.paint[opacityType + '-opacity'] = startVal;
                    console.log(layer.paint, "HERE");
                }

                if (startVal) { // if start val exists which it does for raster
                    if (parseFloat(startVal)) {
                        layer.paint[opacityType + '-opacity'] = opacityVal;
                        console.log(layer.paint, "After IF", startVal, opacityVal);
                    } else {
                        layer.paint[opacityType + '-opacity'] = JSON.parse(JSON.stringify(startVal));
                        console.log(layer.paint, "After ELSE");
                        if (startVal.base) {
                            layer.paint[opacityType + '-opacity'].base = startVal.base * opacityVal;
                            console.log(startVal.base, layer.paint, "What is .base");
                        }
                        if (startVal.stops) {
                            multiplyStopValues(layer.paint[opacityType + '-opacity'].stops, opacityVal);
                            console.log(startVal.stops, layer.paint, "WHat is .stops");
                        }
                    }
